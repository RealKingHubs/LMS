(function () {
  ...
  function getTrackWeekVideo(
    ...
    const sequenceIndex =
      ((semesterNumber - 1) * 4 + (monthNumber - 1)) * 4 + (weekNumber - 1);
    return buildCurriculumVideoUrl(
      trackSequence[sequenceIndex],
      fallbackVideoUrl,
    );
  }
  ...
  function buildLearningWeeks(
    ...
    return lessons.map((lesson, index) => ({
      ...
      type: "learning",
      videoUrl: getTrackWeekVideo(
        trackKey,
        semesterNumber,
        monthNumber,
        index + 1,
        videoLib[videoKeys[index]] || videoLib[videoKeys[0]] || "",
      ),
    ...
    return [
      {
        ...
        objective:
          "Review the lab brief, confirm your environment, and prepare the delivery plan for the month.",
        type: "lab",
        videoUrl: getTrackWeekVideo(
          trackKey,
          semesterNumber,
      ...
      },
      {
        ...
        objective:
          "Implement the core lab tasks and document your approach as you build.",
        type: "lab",
        videoUrl: getTrackWeekVideo(
          trackKey,
          semesterNumber,
      ...
      },
      {
        ...
        objective:
          "Test the lab output, fix issues, and improve the quality of the final delivery.",
        type: "lab",
        videoUrl: getTrackWeekVideo(
          trackKey,
          semesterNumber,
      ...
      },
      {
        ...
        objective:
          "Record, present, and reflect on your completed hands-on lab delivery for the semester.",
        type: "lab",
        videoUrl: getTrackWeekVideo(
          trackKey,
          semesterNumber,
      ...
      months: [
        {
          ...
          phase: "Learning",
          weeks: buildLearningWeeks(
            videoLib,
            trackKey,
            semesterNumber,
            1,
            learningMonths[0].lessons,
            learningMonths[0].videos,
          ),
        },
        {
          ...
          weeks: buildLearningWeeks(
            ...
            semesterNumber,
            2,
            learningMonths[1].lessons,
            learningMonths[1].videos,
          ),
        },
        {
          ...
          weeks: buildLearningWeeks(
            ...
            semesterNumber,
            3,
            learningMonths[2].lessons,
            learningMonths[2].videos,
          ),
        },
        {
  ...
  const TRACKS = {
    "cloud-engineering": {
      ...
      summary:
        "Infrastructure, automation, operations, resilience, and production delivery.",
      outcomes: [
        "Cloud foundations",
      ...
      announcements: [
        {
          id: "cloud-ann-1",
          title: "Infrastructure review window is open",
          body: "Submit your infrastructure diagrams before Friday to receive review comments during the hands-on lab month.",
          date: "April 5, 2026",
          createdAt: "2026-04-05T08:00:00Z",
        },
        {
          id: "cloud-ann-2",
          title: "Monitoring workshop recording uploaded",
          body: "The latest monitoring and alerting session has been added to your learning library.",
          date: "April 3, 2026",
          createdAt: "2026-04-03T09:30:00Z",
        },
        {
          id: "cloud-ann-3",
          title: "Hands-on lab month guide published",
          body: "You can now review the cloud hands-on lab structure in the month four section.",
          date: "April 1, 2026",
      ...
      semesters: [
        buildSemester(
          ...
          "cloud-engineering",
          1,
          "Core Cloud Foundations",
          [
            {
              title: "Linux and Networking Fundamentals",
              summary:
                "Build the operating system and networking base for cloud work.",
              lessons: [
                "Linux command line essentials",
                "Networking layers and ports",
                "DNS, routing, and troubleshooting",
                "Cloud-ready shell practice",
              ],
              videos: ["linux", "cloud", "cloud", "linux"],
            },
            {
              title: "Cloud Foundations and IAM",
              summary:
                "Understand accounts, access control, and core cloud services.",
              lessons: [
              ...
              videos: ["cloud", "security", "cloud", "cloud"],
            },
            {
              title: "Compute, Storage, and Architecture",
              summary: "Design a stable baseline environment for applications.",
              lessons: [
                "Virtual machines and autoscaling",
                "Storage classes and backups",
                "Reference architecture patterns",
                "Reliability fundamentals",
              ],
              videos: ["cloud", "cloud", "cloud", "security"],
            },
          ],
        ...
        buildSemester(
          ...
          "cloud-engineering",
          2,
          "Automation and Platform Delivery",
          [
            {
              title: "Containers and Docker",
              summary:
                "Containerize applications and manage repeatable delivery.",
              lessons: [
                "Docker images and layers",
                "Compose files and local stacks",
                "Container debugging",
                "Secure image practices",
              ],
              videos: ["docker", "docker", "docker", "security"],
            },
            {
              title: "Infrastructure as Code and CI/CD",
              summary: "Automate environments and deployment pipelines.",
              lessons: [
                "Infrastructure as code principles",
                "Pipeline design",
                "Secrets and environment control",
                "Release automation",
              ],
              videos: ["cicd", "cicd", "security", "cicd"],
            },
            {
              title: "Kubernetes and Monitoring",
              summary: "Run applications at scale and observe their health.",
              lessons: [
                "Kubernetes core objects",
                "Workloads and services",
                "Observability basics",
                "Scaling and recovery drills",
              ],
              videos: ["kubernetes", "kubernetes", "cloud", "kubernetes"],
            },
          ],
          ...
          [
            {
              ...
              summary: "Improve uptime, auditability, and incident readiness.",
              lessons: [
              ...
              videos: ["security", "cloud", "security", "security"],
            },
            {
              title: "Data Platforms and Platform Operations",
              summary: "Support data-heavy systems and platform operations.",
              lessons: [
                "Managed data services",
                "Queues and event flows",
                "Platform operations handbook",
                "Service ownership",
              ],
              videos: ["database", "api", "cloud", "cloud"],
            },
            {
              title: "Capstone Delivery and Career Readiness",
              summary: "Present a production-style cloud delivery project.",
              lessons: [
                "Capstone planning",
              ...
              videos: ["cloud", "cicd", "kubernetes", "cloud"],
            },
          ],
    ...
    "frontend-engineering": {
      ...
      summary:
        "Modern web interfaces, design systems, performance, testing, and deployment.",
      outcomes: [
      ...
      announcements: [
        {
          id: "frontend-ann-1",
          title: "Revision projects updated",
          body: "Semester revision now includes component audit and responsive cleanup tasks.",
          date: "April 5, 2026",
          createdAt: "2026-04-05T07:30:00Z",
        },
        {
          id: "frontend-ann-2",
          title: "Lab delivery rubric published",
          body: "Review the latest hands-on lab grading rubric before your next delivery cycle.",
          date: "April 2, 2026",
          createdAt: "2026-04-02T13:00:00Z",
        },
        {
          id: "frontend-ann-3",
          title: "Portfolio review slots available",
          body: "You can now book feedback time for your frontend semester capstone.",
          date: "March 30, 2026",
          ...
          [
            {
              ...
              summary:
                "Understand the base layers of the web and build solid layouts.",
              lessons: [
                "Semantic HTML structure",
                "Responsive CSS foundations",
                "Layout systems and spacing",
                "Accessible form patterns",
              ],
              videos: ["html", "css", "css", "html"],
            },
            {
              title: "JavaScript Core Skills",
              summary:
                "Control behaviour and interactive user flows in the browser.",
              lessons: [
                "Variables and functions",
                "Arrays, objects, and state",
                "DOM updates and events",
                "Fetch and async behaviour",
              ],
              videos: ["javascript", "javascript", "javascript", "api"],
            },
            {
              title: "Responsive UI Delivery",
              summary: "Ship polished and maintainable interface work.",
              lessons: [
                "Responsive components",
                "Animation fundamentals",
                "Design handoff practice",
                "Mini project delivery",
              ],
              videos: ["css", "css", "html", "javascript"],
            },
          ],
          ...
          [
            {
              ...
              summary:
                "Build reusable interfaces with component-driven development.",
              lessons: [
              ...
              videos: ["react", "react", "react", "react"],
            },
            {
              title: "Routing, State, and APIs",
              summary:
                "Manage application state and data flows with confidence.",
              lessons: [
                "Client routing",
                "State architecture",
              ...
              videos: ["react", "react", "api", "api"],
            },
            {
              title: "Testing and Quality",
              summary:
                "Increase confidence through testing and review discipline.",
              lessons: [
              ...
              videos: ["javascript", "javascript", "react", "react"],
            },
          ],
          ...
          [
            {
              ...
              summary: "Create durable systems for complex products.",
              lessons: [
              ...
              videos: ["react", "css", "html", "react"],
            },
            {
              title: "Framework Delivery",
              summary: "Prepare frontend systems for production deployment.",
              lessons: [
              ...
              videos: ["react", "react", "cicd", "cloud"],
            },
            {
              title: "Capstone and Portfolio",
              summary:
                "Ship a polished frontend capstone with presentation support.",
              lessons: [
                "Capstone planning",
              ...
              videos: ["react", "react", "javascript", "react"],
            },
          ],
    ...
    "backend-engineering": {
      ...
      summary:
        "Server-side systems, APIs, databases, security, testing, and deployment.",
      outcomes: [
        "API design",
      ...
      announcements: [
        {
          id: "backend-ann-1",
          title: "New API review checklist",
          body: "A backend API review checklist is now available in the hands-on lab section.",
          date: "April 4, 2026",
          createdAt: "2026-04-04T08:30:00Z",
        },
        {
          id: "backend-ann-2",
          title: "Hands-on lab support guide confirmed",
          body: "A backend lab support guide has been published for all learners this week.",
          date: "April 2, 2026",
          createdAt: "2026-04-02T09:45:00Z",
        },
        {
          id: "backend-ann-3",
          title: "Capstone API examples uploaded",
          body: "Reference backend capstone responses are now available in the resources panel.",
          date: "March 29, 2026",
      ...
      semesters: [
        buildSemester(
          ...
          [
            {
              title: "Programming and Runtime Foundations",
              summary:
                "Start with the base concepts that shape backend systems.",
              lessons: [
              ...
              videos: ["javascript", "node", "node", "node"],
            },
            {
              title: "Databases and Data Modelling",
              summary:
                "Understand how applications persist and structure data.",
              lessons: [
              ...
              videos: ["database", "database", "database", "database"],
            },
            {
              title: "API Construction",
              summary: "Build clear and maintainable backend interfaces.",
              lessons: [
                "REST principles",
          ...
          [
            {
              ...
              summary: "Protect systems and manage user access responsibly.",
              lessons: [
                "Sessions and tokens",
                "Password handling",
              ...
              videos: ["security", "security", "security", "security"],
            },
            {
              title: "Testing and Observability",
              summary: "Improve release confidence and production visibility.",
              lessons: [
              ...
              videos: ["node", "api", "cloud", "cloud"],
            },
            {
              title: "Service Reliability",
              summary:
                "Support growing systems with better architecture and operations.",
              lessons: [
                "Caching concepts",
          ...
          [
            {
              ...
              summary: "Move from application code to production operations.",
              lessons: [
                "Service boundaries",
                "Container delivery",
              ...
              videos: ["node", "docker", "cicd", "cloud"],
            },
            {
              title: "Performance and Data Services",
              summary: "Design for speed, scale, and reliable data access.",
              lessons: [
                "Query optimisation",
              ...
              videos: ["database", "database", "cloud", "security"],
            },
            {
              title: "Capstone System Delivery",
              summary:
                "Present a backend capstone that feels production-ready.",
              lessons: [
                "Capstone planning",
                "Implementation sprint",
              ...
              videos: ["api", "node", "security", "cloud"],
            },
          ],
  ...
  const DEMO_MESSAGES = [
    {
      id: "msg-1",
      authorId: "cloud-mentor",
      authorName: "Cloud Support Desk",
      authorTrack: "Cloud Engineering",
      trackId: "cloud-engineering",
      body: "Use this room for cloud lab blockers, deployment questions, and revision updates related to cloud engineering.",
      createdAt: "2026-04-05T08:00:00Z",
    },
    {
      id: "msg-2",
      authorId: "cloud-learner",
      authorName: "Kemi Adebayo",
      authorTrack: "Cloud Engineering",
      trackId: "cloud-engineering",
      body: "I finished the Linux command line revision today. The guided notes in semester one were especially helpful.",
      createdAt: "2026-04-05T09:15:00Z",
    },
    {
      id: "msg-3",
      authorId: "frontend-mentor",
      authorName: "Frontend Studio",
      authorTrack: "Frontend Engineering",
      trackId: "frontend-engineering",
      body: "Use this room for component review questions, UI blockers, and frontend project updates.",
      createdAt: "2026-04-05T08:20:00Z",
    },
    {
      id: "msg-4b",
      authorId: "frontend-learner",
      authorName: "Paul Nwosu",
      authorTrack: "Frontend Engineering",
      trackId: "frontend-engineering",
      body: "For anyone revising React state, the month four hands-on lab guide covers a clean component structure that is worth reviewing.",
      createdAt: "2026-04-05T10:10:00Z",
    },
    {
      id: "msg-5",
      authorId: "backend-mentor",
      authorName: "Backend Lab",
      authorTrack: "Backend Engineering",
      trackId: "backend-engineering",
      body: "Use this room for backend debugging, API design questions, and delivery support for backend learners.",
      createdAt: "2026-04-05T08:40:00Z",
    },
    {
      id: "msg-6",
      authorId: "backend-learner",
      authorName: "Amina Yusuf",
      authorTrack: "Backend Engineering",
      trackId: "backend-engineering",
      body: "I just submitted my API validation task. If anyone wants feedback on route design, I am available in this thread.",
